...
MiniGameManager::MiniGameManager()
{
	...
	m_miniGameInformations[FoodType::BaguetteWheel] = { { 1, 1, 5, 8 }, { 2, 1, 5, 8}, { 3, 1, 5, 8}, { 4, 1, 5, 8}, {5, 1, 5, 8} };
	
	// 바나나
	m_miniGameInformations[FoodType::Banana] = { { 1, 1, 5, 8 }, { 2, 1, 5, 8}, { 3, 1, 5, 8}, { 4, 1, 5, 1}, {5, 1, 5, 1} };
}
