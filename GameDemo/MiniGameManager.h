...
public:
	...
	void CheatAllClear()
	{ 
		m_clearEatSpot.push_back(FoodType::Ham);
		m_clearEatSpot.push_back(FoodType::Crab);
		m_clearEatSpot.push_back(FoodType::Apple);
		m_clearEatSpot.push_back(FoodType::CupCake);
		m_clearEatSpot.push_back(FoodType::BaguetteWheel);
	}
