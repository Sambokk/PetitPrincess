...
// 멤버 함수 ----------------------------------------------------------------------------------------
	void SetMinMaxLuma(float min, float max) { m_minLuma = min, m_maxLuma = max; }
	void SetMinMaxRatio(float ratio) { m_minLuma *= ratio; m_maxLuma *= ratio; }
...
private:
	...
	Vector3 c1 = Vector3(255, 133, 54);
	Vector3 c2 = Vector3(255, 201, 150);
	Vector3 c3 = Vector3(255, 130, 93);
